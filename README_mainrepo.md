<!--
  ┌─────────────────────────────────────────────────────────────────────────┐
  │  README_mainrepo.md — READ-ONLY MIRROR of upstream artokun/comfyui-mcp   │
  ├─────────────────────────────────────────────────────────────────────────┤
  │  This file is NOT PixelForge's own README and is not what GitHub/npm     │
  │  render for this repo (only `README.md` is). It is a verbatim snapshot   │
  │  of the upstream project's README, kept here as a reference for the      │
  │  full generic ComfyUI toolset, installation options, and panel/agent     │
  │  features this fork inherits but doesn't re-document in its own README.  │
  │                                                                           │
  │  DO NOT hand-edit. It is refreshed during an upstream sync via:          │
  │    git show upstream/main:README.md > README_mainrepo.md                 │
  │  (see the "Syncing with upstream" section in CLAUDE.md /                 │
  │  PixelForgeDocumentations/fork-customization/upstream-sync.md).          │
  │                                                                           │
  │  Snapshot source: upstream/main : README.md                              │
  └─────────────────────────────────────────────────────────────────────────┘
-->
