...
>
  ...
  **self-heals** after a full reconnect/reload/workflow-switch instead of getting
  stuck on a dead tab, the **complete OpenRouter model list**, a Windows
  `restart_comfyui` fix, and a **third-party host** protocol guide. _July 28, 2026_
</Card>
...
>
  ...
  and idle auto-stop; the **LoRA trainer** learns to train on rented pods; plus
  `resolve_missing_models` and provider model discoverability. _July 21, 2026_
</Card>
