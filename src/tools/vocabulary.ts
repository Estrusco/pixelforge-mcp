...
export const TOOL_NAMES = [
  ...
  "list_packs",
  "calculate",
  // PixelForge fork addition, registered at this slot in TOOL_GROUPS (not part of
  // upstream's own ledger). See tool-surface.md for the locked 8-tool MVP surface.
  "pixelate_image",
  ...
  "batch",
  "kitchen",
  // Remaining PixelForge fork additions (src/sprite/, src/tools/secrets.ts,
  // src/tools/remove-background.ts) — not part of upstream's own ledger, appended
  // in TOOL_GROUPS registration order. See tool-surface.md for the locked 8-tool
  // MVP surface (generate_sprite through export_for_engine, plus remove_background)
  // and PixelForgeDocumentations/fork-customization/locked-decisions.md.
  "generate_sprite",
  "get_sprite_result",
 ...
 */
export const BASELINE_SHA256 = "ae330bd7bde46c1e120273ce76543074474b357f0abd1110e19821b4c1bec356";
...
export const DEAD_NAMES: readonly DeadName[] = [
  ...
  // NOTE: upstream's own `remove_background` DEAD_NAMES entry (retired 0.50.0,
  // folded into generate_image action:"remove_background") does NOT apply to this
  // fork — remove_background stays a locked, standalone PixelForge MVP tool (see
  // tool-surface.md and locked-decisions.md), restored in TOOL_GROUPS/TOOL_NAMES
  // during the 2026-09-09 upstream sync. removeBackgroundAction still backs
  // upstream's own folded action too, so both call forms share one implementation.
  {
